...
if [ $COUNT -gt 0 ] ; then
	...
	for j in $WORTLIST ; do
		...
		CNT=$((CNT + 1))
		echo $WORDCNT >> $OUTPUTDIR/output_typetoken_lemma_${POSTAGLIST}_${DAYMIN}_${DAYMAX}.csv
	done
	echo "----|----" >> $OUTPUTDIR/output_typetoken_lemma_${POSTAGLIST}_${DAYMIN}_${DAYMAX}.csv
	echo "$CNT|$WORDCNTSUM" >> $OUTPUTDIR/output_typetoken_lemma_${POSTAGLIST}_${DAYMIN}_${DAYMAX}.csv
	echo "${POSTAGLIST}|${DAYMIN}|${DAYMAX}||$CNT|$WORDCNTSUM" >> $OUTPUTDIR/../output_typetoken_lemma_summary_${DAYMIN}_${DAYMAX}.csv
