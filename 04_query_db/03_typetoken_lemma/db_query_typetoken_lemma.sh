...
for j in $WORTLIST ; do
	...
	CNT=$((CNT + 1))
	echo $WORDCNT >> $OUTPUTDIR/output_typetoken_lemma_${POSTAG}_${DAYMIN}_${DAYMAX}.csv
done
echo "----|----" >> $OUTPUTDIR/output_typetoken_lemma_${POSTAG}_${DAYMIN}_${DAYMAX}.csv
echo "$CNT|$WORDCNTSUM" >> $OUTPUTDIR/output_typetoken_lemma_${POSTAG}_${DAYMIN}_${DAYMAX}.csv
echo "${POSTAG}|${DAYMIN}|${DAYMAX}||$CNT|$WORDCNTSUM" >> $OUTPUTDIR/../output_typetoken_lemma_summary.csv
